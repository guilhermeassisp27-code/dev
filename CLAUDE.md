...
7. **Conteúdo e criativos (marketing e textos do produto)**: sem emoji e sem "cara de IA".
   ...
   - **Vídeo de Reels**: produzido em CapCut/Canva (substituiu o avatar de IA do fundador, 2026-07-12) — sem limite rígido de 10s; seguir a duração recomendada de Reels (15-30s), uma ideia objetiva por roteiro. Formato preferido: gravação de tela do produto (Dashboard, Funil, Registro de Visita) editada com texto na tela, em vez de avatar sintético. Conteúdo com várias partes ainda vira carrossel em vez de tentar caber tudo num Reel só.
