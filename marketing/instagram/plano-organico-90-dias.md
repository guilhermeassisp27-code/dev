# Plano de Crescimento Orgânico — 90 dias (Selo)

> Objetivo: escalar o Selo pelo Instagram com **conteúdo rico** (não só vender a ferramenta),
> virar **referência** pro corretor autônomo e converter audiência em **testes grátis → assinaturas**.
> Regra de ouro: **80% valor / 20% produto**. Ninguém segue quem só se vende.
...
|---|---|
| Seguidores qualificados (corretores) | crescer de forma consistente toda semana |
| Salvamentos + compartilhamentos | principal sinal de alcance — priorizar |
| Cliques na bio (link do teste grátis) | crescente, com pico nas semanas de oferta |
| Testes grátis iniciados | meta real: virar rotina a partir da Fase 2 |
| Assinantes pagantes | conversão começa leve (Fase 1) e escala (Fase 3) |

**Não perseguir vaidade (curtidas).** Perseguir: **salvou, compartilhou, comentou, clicou na bio, testou.**

---

## 🎭 O avatar (anime corretor) — persona e voz

O avatar é **um corretor de sucesso, gente boa e direto** — já passou perrengue (perdeu venda, trabalhou no caderno, fez proposta no Word) e hoje ajuda outros corretores. Fala **de igual pra igual**, não de cima.

- **Tom:** informal, brasileiro, energia de quem vende de verdade. Nada de "guru". Frases curtas.
- **Pessoa:** 1ª pessoa, falando PRA outro corretor ("cê", "tu", "a gente").
- **Promessa:** todo Reel entrega UMA ideia útil em 30-45s. Sai melhor do que entrou.
- **Selo aparece como ferramenta dele**, naturalmente — não como propaganda forçada.
- **Assinatura verbal de fecho** (use sempre que couber): *"Sua comissão, garantida."*

> Como usar os roteiros abaixo: o texto em **"FALA:"** é o que o avatar narra. O **"TELA:"** é a sugestão de texto na imagem. O **"CTA:"** é o fecho.

---

## 🧱 Os 5 pilares de conteúdo

| # | Pilar | Pra quê | Frequência |
|---|---|---|---|
| 1 | 🎯 **Vendas & Persuasão** | ensinar a vender/fechar mais | alta |
| 2 | 🧠 **Mercado & Dinheiro** | financiamento, FGTS, juros, docs | alta |
| 3 | ⚙️ **Rotina & Organização** | produtividade, não perder lead | média (Selo entra natural) |
| 4 | 💛 **Bastidores & Posicionamento** | marca, mentalidade, história | média |
| 5 | 🛡️ **Produto (Selo)** | mostrar a ferramenta/prova | ~1 a cada 4-5 posts |

---

## 🗓️ Cadência semanal (sustentável pra 1 pessoa)

**4 posts no feed + Stories todo dia.**

| Dia | Formato | Normalmente |
|---|---|---|
| **Terça** | 🎬 Reel (avatar) | Vendas ou Mercado (alcance) |
| **Quarta** | 🎠 Carrossel | Educativo (salvamento/autoridade) |
...
Sempre no **1º comentário** (deixa a legenda limpa). Misture 3 níveis (15-20 tags):
- **Amplo:** #corretordeimoveis #imoveis #mercadoimobiliario #imobiliaria
- **Nicho:** #corretorautonomo #corretordesucesso #crmimobiliario #vendasimobiliarias #dicasparacorretores
- **Marca/cauda longa:** #seloapp #rotinadocorretor #corretoriniciante #propostacomercial #marketingimobiliario #consultorimobiliario

---

## 🚀 Táticas de crescimento (fazer SEMPRE)

1. **Responda todo comentário** nas 2 primeiras horas — o algoritmo lê como conversa quente.
2. **"Comenta X que eu te mando"** — gera engajamento + lista de interessados (responde no direct com o link).
3. **Peça salvamento** nos carrosséis ("salva pra não esquecer").
4. **Reaproveite tudo:** 1 carrossel vira Reel, vira 3 stories, vira post estático. 1 ideia = 4 conteúdos.
5. **Colabore (collab post)** com corretores parceiros e perfis do nicho a partir da Fase 2.
6. **CTA na bio sempre atualizado:** "Teste o Selo 7 dias grátis 👇" + link.
7. **Engaje 15 min/dia** em perfis de corretores (comentários reais) — atrai de volta.
...
- Comentários e dúvidas (caixinha) → **banco de ideias** infinito pros próximos meses.

## 📈 Revisão (a cada 30 dias)
1. Quais 3 posts tiveram mais **salvamento/compartilhamento**? → faça MAIS daquele tema/formato.
2. Quais tiveram mais **clique na bio**? → repita a estrutura de CTA.
3. Corte o que não engajou. Dobre no que funcionou. **O plano serve à audiência, não o contrário.**

---

### Resumo do que pedir ao gerador de vídeo (avatar anime)
Para cada Reel: use o texto em **"FALA:"** como narração do avatar corretor (1ª pessoa, tom de igual pra igual, energia, frases curtas). Os textos em **"TELA:"** entram como legenda/destaque na imagem. Sempre legendar. Sempre terminar com o **CTA**.
