...
> Nota: o arquivo de referências completo (as 139 ideias com descrição) não
> foi importado junto com esta skill — só a tabela-resumo acima está
> disponível. Se você tiver o arquivo original, adicione-o em
> `references/ideas-by-category.md` nesta mesma pasta.
